...
use_cryolo  # to use non-default version, add version number as an argument

module list
echo "Conda environment: $(basename $CONDA_DEFAULT_ENV)"

'/usr/users/rubsak/sw/conda/cryolo-1.9/bin/python3.7' -u '/usr/users/rubsak/sw/conda/cryolo-1.9/bin/cryolo_gui.py' --ignore-gooey predict -c '/scratch1/projects/rubsak/tapu/Cryolo/Arsen/config_cryolo.json' -w '/scratch1/projects/rubsak/tapu/Cryolo/Arsen/cryolo_model.h5' -i /scratch1/projects/rubsak/tapu/Cryolo/Arsen/Input -o 'Output' -t '0.3' -d '0' -pbs '3' --gpu_fraction '1.0' -nc '-1' --norm_margin '0.0' --filament -bd '10' -sm 'LINE_STRAIGHTNESS' -st '0.95' -sr '1.41' -ad '10' --directional_method 'PREDICTED' -mw '100' --tomogram -tsr '-1' -tmem '0' -mn3d '2' -tmin '5' -twin '-1' -tedge '0.4' -tmerge '0.8'
